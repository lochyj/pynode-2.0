...
def pause(time):
    pynode.add_event(pynode.EventPause(time))
def delay(func, time, args=[], repeat=False):
    def execute():
        pynode.execute_function(func, args)
    if repeat:
        delay_id = pynode.timer.set_interval(execute, time)
        pynode.PynodeCoreGlobals.delay_type[delay_id] = 1
        return delay_id
    else:
        delay_id = pynode.timer.set_timeout(execute, time)
        pynode.PynodeCoreGlobals.delay_type[delay_id] = 0
        return delay_id
def cancel_delay(delay_id):
    if delay_id in pynode.PynodeCoreGlobals.delay_type:
        if pynode.PynodeCoreGlobals.delay_type[delay_id] == 1: pynode.timer.clear_interval(delay_id)
        else: pynode.timer.clear_timeout(delay_id)
        del pynode.PynodeCoreGlobals.delay_type[delay_id]
def clear_delays():
    delay_ids = list(pynode.PynodeCoreGlobals.delay_type.keys())
    for delay_id in delay_ids:
        cancel_delay(delay_id)

def print_debug(value):
    pynode.do_print(str(value) + "\n")

def register_click_listener(func):
    pynode.PynodeCoreGlobals.click_listener_func["f"] = func
...
class Node:
    def __init__(self, *args, **kwds):
        arg_id = kwds["id"] if "id" in kwds else args[0] if len(args) > 0 else pynode.next_user_id()
        ...
        self._internal_id = pynode.next_global_id()

    def set_value(self, value):
        self._value = value
        pynode.add_event(pynode.Event(pynode.js_node_set_value, [self._internal_id, str(value) if value is not None else ""]), self)
        return self
    def value(self):
        return self._value
    ...
    def set_position(self, x, y=None, relative=False):
        ...
        pynode.add_event(pynode.Event(pynode.js_node_set_position, [self._internal_id, x, y, relative]), self)
        return self

    # Note: Function should be used asynchronously in the online version. Call it in delayed and/or click listener functions.
    def position(self):
        data = pynode.get_data((pynode.Event(pynode.js_node_get_position, [self._internal_id])))
    ...
    def set_label(self, text, label_id=0):
        ...
        pynode.add_event(pynode.Event(pynode.js_node_set_label, [self._internal_id, str(text) if text is not None else "", label_id]), self)
        return self
    ...
    def set_size(self, size):
        self._size = size
        pynode.add_event(pynode.Event(pynode.js_node_set_size, [self._internal_id, size]), self)
        return self
    def size(self): return self._size

    def set_color(self, color):
        self._color = color
        pynode.add_event(pynode.Event(pynode.js_node_set_color, [self._internal_id, color.hex_string(), self._value_style.data(self)]), self)
        return self
    def color(self): return self._color

    def set_text_size(self, size):
        self._value_style._size = size
        pynode.add_event(pynode.Event(pynode.js_node_set_value_style, [self._internal_id, self._value_style.data(self)]), self)
        return self
    ...
    def set_label_style(self, size=None, color=None, outline=None, label_id=None):
        if label_id is None or (label_id != 0 and label_id != 1):
            ...
            pynode.add_event(pynode.Event(pynode.js_node_set_label_style, [self._internal_id, self._label_styles[0].data(self), 0]), self)
            pynode.add_event(pynode.Event(pynode.js_node_set_label_style, [self._internal_id, self._label_styles[1].data(self), 1]), self)
        else:
            ...
            pynode.add_event(pynode.Event(pynode.js_node_set_label_style, [self._internal_id, self._label_styles[label_id].data(self), label_id]), self)
        return self
    ...
    def highlight(self, *args, **kwds):
        ...
        pynode.add_event(pynode.Event(pynode.js_node_highlight, [self._internal_id, arg_size, arg_color.hex_string() if arg_color is not None else None]), self)
...
class Edge:
    ...
    def set_weight(self, weight=None):
        self._weight = weight
        pynode.add_event(pynode.Event(pynode.js_edge_set_weight, [self._internal_id, str(weight) if weight is not None else ""]), self)
        return self
    def weight(self):
        return self._weight
    ...
    def set_directed(self, directed=True):
        self._directed = directed
        pynode.add_event(pynode.Event(pynode.js_edge_set_directed, [self._internal_id, self._directed]), self)
        return self
    def directed(self):
    ...
    def set_width(self, width=2):
        self._width = width
        pynode.add_event(pynode.Event(pynode.js_edge_set_width, [self._internal_id, width]), self)
        return self
    def width(self): return self._width

    def set_color(self, color=Color.LIGHT_GREY):
        self._color = color
        pynode.add_event(pynode.Event(pynode.js_edge_set_color, [self._internal_id, color.hex_string()]), self)
        return self
    def color(self): return self._color
    ...
    def set_weight_style(self, size=None, color=None, outline=None):
        ...
        pynode.add_event(pynode.Event(pynode.js_edge_set_weight_style, [self._internal_id, self._weight_style.data(self)]), self)
        return self

    def highlight(self, *args, **kwds):
        arg_color = kwds["color"] if "color" in kwds else args[0] if len(args) > 0 else None
        arg_width = kwds["width"] if "width" in kwds else args[1] if len(args) > 1 else self._width * 2
        pynode.add_event(pynode.Event(pynode.js_edge_highlight, [self._internal_id, arg_width, arg_color.hex_string() if arg_color is not None else None]), self)
    ...
    def traverse(self, initial_node=None, color=Color.RED, keep_path=True):
        ...
        pynode.add_event(pynode.Event(pynode.js_edge_traverse, [self._internal_id, start._internal_id, color.hex_string(), keep_path]), self)
...
class Graph:
    ...
    def add_node(self, *args, **kwds):
        ...
        self._nodes[n._id] = n
        pynode.add_event(pynode.Event(pynode.js_add_node, [n._data()]))
        pause(25)
        return n

    def remove_node(self, node):
        n = self.node(node)
        pynode.enable_events(False)
        for e in n.incident_edges():
            self.remove_edge(e)
        pynode.enable_events(True)
        del self._nodes[n._id]
        pynode.add_event(pynode.Event(pynode.js_remove_node, [n._internal_id]))
        pause(25)
        return n
    ...
    def add_edge(self, *args, **kwds):
        ...
        pynode.add_event(pynode.Event(pynode.js_add_edge, [e._data()]))
        return e
    ...
    def remove_edge(self, *args, **kwds):
        ...
        if remove_multiple:
            ...
            pynode.add_event(pynode.Event(pynode.js_remove_edge, [edge._internal_id]))
            return edge
    ...
    @staticmethod
    def random(order, size, connected=True, multigraph=False, initial_id=0):
        nodes = []
        edges = []
        ...
        for e in possible_edges:
            ...
            if (adjacency_matrix[e[0]][e[1]] == 0 and e[0] != e[1]) or multigraph:
    ...
    def add_all(self, elements):
        ...
        pynode.enable_events(True)
        pynode.add_event(pynode.Event(pynode.js_add_all, [new_elements]))
        pause(55)
    ...
    def remove_all(self, elements):
        ...
        pynode.enable_events(True)
        pynode.add_event(pynode.Event(pynode.js_remove_all, [new_elements]))
        pause(55)
    ...
    def set_spread(self, spread=80):
        self._spread = spread
        pynode.add_event(pynode.Event(pynode.js_set_spread, [spread]))

    def clear(self):
        self._reset()
        pynode.add_event(pynode.Event(pynode.js_clear, []))
